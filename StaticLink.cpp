...
COLORREF CStaticLink::g_colorUnvisited = RGB(0,0,128);
COLORREF CStaticLink::g_colorVisited   = RGB(0,128,0);
...
void CStaticLink::SetNavigate(pFNNavigate lpfnNavigate)
{
	m_lpfnNavigate = lpfnNavigate;
}
...
{
	// Test for overriding behavior
	bool bNavigate = true;
	if (m_lpfnNavigate)
		bNavigate = m_lpfnNavigate();
	if (bNavigate)
		Navigate();
}

void CStaticLink::Navigate()
{
